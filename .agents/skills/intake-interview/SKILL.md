...
- Write `.ksor/governance.yaml` from question 3: `version: "0.1"`,
  ...
  `ksor-starter/0.0.58` in `approval_authorities` while any starter
...
- **Offer to start replacing the starter documents — they are already
  ...
  `ksor-starter/0.0.58`, so the site and `llms.txt` carry them from
  ...
  `ksor-starter/0.0.58` from `approval_authorities` in the same
